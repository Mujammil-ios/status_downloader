...
public class BVideoAdapter extends RecyclerView.Adapter<BVideoAdapter.ViewHolder> {

    BVideoFragment context;
    ArrayList<ModelClass> fileslist;

    public BVideoAdapter(BVideoFragment context, ArrayList<ModelClass> fileslist) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new BVideoAdapter.ViewHolder(view);
    }
