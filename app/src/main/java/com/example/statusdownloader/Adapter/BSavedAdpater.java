...
public class BSavedAdpater extends RecyclerView.Adapter<BSavedAdpater.ViewHolder> {

    BSavedFragment context;
    ArrayList<ModelClass> fileslist;

    public BSavedAdpater(BSavedFragment context, ArrayList<ModelClass> fileslist) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new BSavedAdpater.ViewHolder(view);
